...
function ChatRoom() {
  ...
  return (
    <>
      <div className="chat-room w-[50%] h-screen flex flex-col justify-start">
        <div className="chat w-full h-full flex flex-col justify-start overflow-y-scroll">
          {messages.map((message) => (
            <div
              key={message.$id}
              className="w-full message my-4 p-4 flex justify-between items-center"
            >
              <div>
              ...
              <button
                ...
                className="bg-none text-xl text-white hover:text-red-600"
              >
